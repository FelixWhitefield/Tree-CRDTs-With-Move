...
\begin{itemize}
    ...
    \item Each layer should have an interface that allows for the layer to be replaced with a different implementation.
\end{itemize}
