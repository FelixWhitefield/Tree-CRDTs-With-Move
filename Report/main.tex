...
\begin{tikzpicture}
    \begin{axis}[
        ...
        title=Time to Apply All Concurrent Operations
    ]
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        width=1\textwidth, height=7cm,
        legend style={at={(0,1)},anchor=north west, font=\small},
        title=Time to Apply All Sequential Operations
    ]
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        width=1\textwidth, height=7cm,
        legend style={at={(0,1)},anchor=north west, font=\small},
        title=Time to Apply All Operations (Connecting Afterwards),
