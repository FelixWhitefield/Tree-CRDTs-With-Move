...
\begin{itemize}
    ...
    \item \textbf{\href{https://pkg.go.dev/google.golang.org/protobuf}{protobuf}} - Used to encode and decode messages.
    \item \textbf{\href{https://pkg.go.dev/github.com/vmihailenco/msgpack@v4.0.4+incompatible}{msgpack}} - Used to encode and decode operations. \textit{protobuf} cannot be used as it requires the types to be defined in a \texttt{.proto} file. This is not possible for metadata field in the tree nodes as they can be \textit{any} type.
\end{itemize}
